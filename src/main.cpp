...
//         Ошибка -30: Invalid Value
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            size_t deviceSizeMbSize = 0;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, 0, nullptr, &deviceSizeMbSize));
            cl_ulong deviceSizeMb;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, deviceSizeMbSize, &deviceSizeMb, nullptr));
            deviceSizeMb /= 1024 * 1024;
            std::cout << "        Device memory: " << deviceSizeMb << std::endl;
